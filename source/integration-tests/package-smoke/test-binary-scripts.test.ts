...
export const standardSubpathImportScript = [
    ...
    "const simulationModule = await import('@overkill-dev/test/simulation');",
    ...
    'console.log(JSON.stringify(Object.keys(simulationModule)));',
    'console.log(typeof resourcesPackageModule.defineResource);',
    'console.log(typeof resourcesPackageModule.startResources);',
    'console.log(typeof resourcesPackageModule.startRuntime);',
    'console.log(typeof resourcesPackageModule.createSimulatedHttpServerResource);',
    'console.log(typeof simulationPackageModule.defineSimulation);',
    'console.log(typeof simulationHttpPackageModule.startSimulatedHttpServer);',
    ...
    'const simulation = simulationModule.defineSimulation({',
    "    name: 'api',",
...
export const expectedStandardSubpathImportOutput = [
    ...
    '["throwingTest"]',
    '["ResourceLifecycleError","composeRuntimeContext","composeRuntimes","createSimulatedHttpServerResource","createTemporaryDirectoryResource","defineLocalServiceResource","defineResource","defineRuntime","defineRuntimeMatrix","startRuntime","withResource","withResources","withRuntime"]',
