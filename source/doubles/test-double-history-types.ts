import type { CallableSignature, ConstructorSignature } from './double-behavior.ts';
import type { DoubleCall, DoubleConstruction, DoubleResult } from './double-history.ts';
