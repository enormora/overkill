...
const unknownSourceLocations = [ unknownSourceLocation ] as const;

const check = createCompositeCheckBuilder('assert', null, unknownSourceLocations);
...
function deepAssertion(
    ...
    return {
        ...
        message: null,
        source: 'assert',
        sourceLocations: unknownSourceLocations
    };
}
